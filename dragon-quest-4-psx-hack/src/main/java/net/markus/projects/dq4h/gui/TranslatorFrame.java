...
public class TranslatorFrame extends javax.swing.JFrame implements ProjectListener {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jSplitPaneMain, javax.swing.GroupLayout.DEFAULT_SIZE, 453, Short.MAX_VALUE)
        );
    ...
    private void jMenuItemMailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemMailActionPerformed
        project.sendMail("todo@todo.net", getTitle(), jTextAreaLog.getText());
    ...
    private void log(String line) {
        try {
            ...
            String ln = LocalDateTime.now().format(formatter) + " " + line + "\n";
    ...
    /**
     * Runs a {@link ThrowableRunnable}. If it throws an exception its stacktrace is shown in the log. 
     * This also resets the {@link #jProgressBarMain}.
     * The exception is printed.
     * It uses {@link SwingWorker} to do it in background to prevent GUI blocking.
